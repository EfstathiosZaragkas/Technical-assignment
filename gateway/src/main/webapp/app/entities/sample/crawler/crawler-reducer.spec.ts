...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './crawler.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRAWLER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CRAWLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRAWLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRAWLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRAWLER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRAWLER actions', async () => {
      const expectedActions = [
        {
