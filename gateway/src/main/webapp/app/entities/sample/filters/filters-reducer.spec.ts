...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './filters.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILTERS_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILTERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILTERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILTERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILTERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILTERS actions', async () => {
      const expectedActions = [
        {
